...
),  dbt__cte__src_wip_move_transactions__ as (
SELECT
  ...
  fm_operation_code AS wmt_fm_operation_code,
  ...
  to_operation_code AS wmt_to_operation_code,
  ...
  scrap_account_id AS wmt_scrap_account_id,
...
FROM
    ...
    stg_from_wop_we_wdj
    LEFT JOIN dbt__cte__src_wip_move_transactions__
    src_wmt
...
),  dbt__cte__int_move_trxns_dynamic_daily_rate__ as (
SELECT
...
SELECT
    ...
    int_move_trxns_dynamic_daily_rate.nvl_wmt_wop_fm_operation_seq_num "FM OP SEQ NUM",
...
FROM
    dbt__cte__int_move_trxns_dynamic_daily_rate__
