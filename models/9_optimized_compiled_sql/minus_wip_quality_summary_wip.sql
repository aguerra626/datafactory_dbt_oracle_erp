/*
Follow SQL processing logic for building out minus models
1 JOIN clause with join keys specified in stg_
2 WHERE clause filters specified in src_
3 SELECT clause notably column names specified in marts models
*/
...
fmwop.quantity_waiting_to_move AS "Op To Move",
...
standard_hash(wdj.primary_item_id||wdj.wip_entity_id||fmwop.operation_seq_num, 'MD5') as wip_quality_summary_wip_sk
