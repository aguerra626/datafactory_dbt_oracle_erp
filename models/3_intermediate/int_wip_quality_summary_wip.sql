...
WHERE int_base.wdj_status_type = 3 -- Released
AND int_base.wdj_class_code IN ('CONVERSION','NONSTD-PRJ','Production','REWORK','TECH MKTG','QLTYREWORK') -- exclude NSS- repair jobs